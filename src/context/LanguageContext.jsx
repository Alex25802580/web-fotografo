...
export const translations = {
  en: {
    ...
    gallery: {
      ...
      emptyCategory: 'There are no published photographs yet.',
  ...
  es: {
    ...
    gallery: {
      ...
      emptyCategory: 'Todavía no hay fotografías publicadas.',
  ...
  ca: {
    ...
    gallery: {
      ...
      emptyCategory: 'Encara no hi ha fotografies publicades.',
